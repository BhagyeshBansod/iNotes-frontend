  ...
  return (
    <div className="about">
      <span className="about-heading">
        {" "}
        Welcome to iNoteBook - Your Notes on Cloud!{" "}
      </span>
      <span className="about-description">
        At iNoteBook, we understand the importance of keeping your thoughts,
        ...
        someone who loves jotting down ideas, iNoteBook is designed to be your
        perfect digital companion.
      </span>
      <span className="about-heading">Our Mission:</span>
      <span className="about-description">
        At iNoteBook, our mission is to provide you with a seamless and
      ...
      <span className="about-description">
        ...
        With iNoteBook, all your notes are securely stored in the cloud,
        ...
        Access your notes on the go! iNoteBook is designed to be responsive,
      ...
      <span className="about-heading"> Why Choose iNoteBook? </span>
      <span className="about-description">
        {" "}
        Seamless Sync: Synchronize your notes across all your devices, so you
        never miss a beat. Productivity Boost: Stay organized, save time, and
        ...
        evolution. With iNoteBook, taking notes has never been more enjoyable
      ...
      <span className="about-description">The iNoteBook Team</span>
    </div>
  );
};
